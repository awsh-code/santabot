...
export default function IndexPage() {
  return (
    ...
    <section className="container min-h-[600px]  grid grid-cols-[1fr_1fr] xs:grid-cols-[1fr]  sm:items-center gap-6 pb-8 pt-6 md:py-10 px-8">
      <div className="flex w-[350px] sm:w-full max-w-[980px] flex-col items-center sm:items-start justify-start sm:justify-center gap-2">
        <motion.img
          src="/snowman_angle.png"
          // src="https://images.unsplash.com/photo-1523275335684-37898b6baf30?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1598&q=80"
          alt="snowman"
          className="object-cover block sm:hidden  w-[150px] absolute bottom-10 right-10 "
          whileTap={{ scale: 0.9 }}
          drag={true}
        ...
        <motion.img
          ...
          alt="christmas_tree"
          className="object-cover block sm:hidden  w-[125px]  absolute bottom-11  left-10"
        ...
        <motion.img
          src="/santa-hat.png"
          alt="santa_hat"
          className="object-cover block sm:hidden  w-[150px]  "
          // className="object-cover  w-[125px]  absolute top-[100px] right-[10px]"
          whileTap={{ scale: 0.9 }}
          drag={true}
          dragConstraints={{ left: 0, right: 0, top: 0, bottom: 0 }}
      ...
      <div className="hidden sm:flex  justify-center align-middle p-2 relative">
        <motion.img
          src="/snowman_angle.png"
          // src="https://images.unsplash.com/photo-1523275335684-37898b6baf30?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1598&q=80"
          alt="snowman"
          className="object-cover hidden sm:block  md:w-[150px] absolute bottom-0 left-0 "
          whileTap={{ scale: 0.9 }}
          drag={true}
          dragConstraints={{ left: 0, right: 250, top: 0, bottom: 50 }}
          initial={{ opacity: 0, y: -100 }}
        ...
        <motion.img
          src="/candy_stick.png"
          alt="candy"
          className="object-cover hidden sm:block  w-[100px]  absolute bottom-10 right-36"
        ...
        <motion.img
          src="/sock.png"
          alt="sock"
          className="object-cover hidden sm:block w-[125px]  absolute top-[100px] left-[125px]"
          whileTap={{ scale: 0.8 }}
          drag={true}
          dragConstraints={{ left: 0, right: 250, top: 0, bottom: 50 }}
          initial={{ opacity: 0, x: -100 }}
        ...
        <motion.img
          src="/christmas_tree.png"
          alt="christmas_tree"
          className="object-cover hidden sm:block  w-[125px]  absolute  right-[10px]"
          // className="object-cover  w-[125px]  absolute top-[100px] right-[10px]"
          whileTap={{ scale: 0.9 }}
          drag={true}
          dragConstraints={{ left: 0, right: 0, top: 0, bottom: 0 }}
